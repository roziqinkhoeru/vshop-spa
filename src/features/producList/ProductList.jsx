          ...
          <div className="w-full grid grid-cols-4 mobile:grid-cols-12 xl:grid-cols-10 gap-4">
            {filteredProducts?.length > 0 ? (
              filteredProducts?.map((product) => (
                <div
                  className="col-span-full xxs:col-span-2 mobile:col-span-4 md:col-span-3 xl:col-span-2 w-full flex flex-col justify-between bg-white p-3 rounded-2xl border border-gray-200"
                  key={product?.id}>
                  <div className="mb-2">
